...
public class DateTime {
	...
	public static String yyyy(String yyyy) {
		return new SimpleDateFormat("yyyy").format(yyyy);
	}
	...
	public static String yyyyMMddHHmm() {
		return new SimpleDateFormat("yyyyMMddHHmm").format(System.currentTimeMillis());
	}
	public static String yyyyMMddHH() {
		return new SimpleDateFormat("yyyyMMddHH").format(System.currentTimeMillis());
	}
	public static String yyyyMMdd() {
		return new SimpleDateFormat("yyyyMMdd").format(System.currentTimeMillis());
	}
	public static String yyyyMM() {
		return new SimpleDateFormat("yyyyMM").format(System.currentTimeMillis());
	}
	...
	public static String yy_MM_dd_HH_mm() {
		return new SimpleDateFormat("yy-MM-dd HH:mm").format(System.currentTimeMillis());
	}
	public static String yy_MM_dd_HH() {
		return new SimpleDateFormat("yy-MM-dd HH").format(System.currentTimeMillis());
	}
	...
	public static String yy_MM() {
		return new SimpleDateFormat("yy-MM").format(System.currentTimeMillis());
	}
	...
	public static String yy_MM_dd_HH(Date date) {
		return new SimpleDateFormat("yy-MM-dd HH").format(date);
	}
	...
	public static String yyMMddhhmmss() {
		return new SimpleDateFormat("yyMMddHHmmss").format(System.currentTimeMillis());
	}
	public static String yyMMddhhmm() {
		return new SimpleDateFormat("yyMMddHHmm").format(System.currentTimeMillis());
	}
	public static String yyMMddhh() {
		return new SimpleDateFormat("yyMMddHH").format(System.currentTimeMillis());
	}
	public static String yyMMdd() {
		return new SimpleDateFormat("yyMMdd").format(System.currentTimeMillis());
	}
	public static String yyMM() {
		return new SimpleDateFormat("yyMM").format(System.currentTimeMillis());
	}
	 ...
	 * @return
	 */
	public static String yyMMddHHmmss2yyyy_MM_dd_HH_mm_ss(String yyMMddHHmmss){
		try {
			return yyyy_MM_dd_HH_mm_ss(new SimpleDateFormat("yyMMddHHmmss").parse(yyMMddHHmmss));
	...
	public static String yyyyMMdd_HH_mm_ss() {
		return new SimpleDateFormat("yyyyMMdd HH:mm:ss").format(System.currentTimeMillis());
	}
	public static String yyyyMMdd_HH_mm() {
		return new SimpleDateFormat("yyyyMMdd HH:mm").format(System.currentTimeMillis());
	}
	public static String yyyyMMdd_HH() {
		return new SimpleDateFormat("yyyyMMdd HH").format(System.currentTimeMillis());
	}
	...
	public static String yyMMdd_HH_mm_ss() {
		return new SimpleDateFormat("yyMMdd HH:mm:ss").format(System.currentTimeMillis());
	}
	public static String yyMMdd_HH_mm() {
		return new SimpleDateFormat("yyMMdd HH:mm").format(System.currentTimeMillis());
	}
	public static String yyMMdd_HH() {
		return new SimpleDateFormat("yyMMdd HH").format(System.currentTimeMillis());
	}
	...
	public static String yyMMdd_HH_mm(Date date) {
		return new SimpleDateFormat("yyMMdd HH:mm").format(date);
	}
	public static String yyMMdd_HH(Date date) {
		return new SimpleDateFormat("yyMMdd HH").format(date);
	}
   ...
   /////////////////////////////////////////	
	...
	public static String dd_hh_mm_ss() {
		return new SimpleDateFormat("ddHH:mm:ss").format(System.currentTimeMillis());
	}
	public static String ddhhmmss() {
		return new SimpleDateFormat("ddHHmmss").format(System.currentTimeMillis());
	}
	...
	public static Date dateFrom_yyyy_MM_dd_HH_mm_ss(String yyyy_MM_dd_HH_mm_ss) throws Exception {
		return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(yyyy_MM_dd_HH_mm_ss);
	}
	public static Date dateFrom_yyyy_MM_dd_HH_mm(String yyyy_MM_dd_HH_mm) throws Exception {
		return new SimpleDateFormat("yyyy-MM-dd HH:mm").parse(yyyy_MM_dd_HH_mm);
	}
	public static Date dateFrom_yyyy_MM_dd_HH(String yyyy_MM_dd_HH) throws Exception {
		return new SimpleDateFormat("yyyy-MM-dd HH").parse(yyyy_MM_dd_HH);
	}
	public static Date dateFrom_yyyy_MM_dd(String yyyy_MM_dd) throws Exception {
		return new SimpleDateFormat("yyyy-MM-dd").parse(yyyy_MM_dd);
	}
	...
	public static Date dateFrom_yyyyMMddHH(String yyyyMMddHH) throws Exception {
		return new SimpleDateFormat("yyyyMMddHH").parse(yyyyMMddHH);
	}
	...
	public static String lastXHour_yyyy_MM_dd_HH(String yyyy_MM_dd_HH , int xhour) throws Exception {
		Date d = new SimpleDateFormat("yyyy-MM-dd HH").parse(yyyy_MM_dd_HH);
	...
	public static String lastXHour_yyyy_MM_dd_HH_mm(String yyyy_MM_dd_HH_mm , int xhour) throws Exception {
		Date d = new SimpleDateFormat("yyyy-MM-dd HH:mm").parse(yyyy_MM_dd_HH_mm);
		Calendar cal = Calendar.getInstance();  
		cal.setTime(d);			
		cal.add(Calendar.HOUR_OF_DAY, -xhour);
		Date date = cal.getTime() ;
	...
	public static String lastXHour_yyyyMMddHH(String yyyyMMddHH , int xhour) throws Exception {
		Date d = new SimpleDateFormat("yyyyMMddHH").parse(yyyyMMddHH);
		Calendar cal = Calendar.getInstance();  
		cal.setTime(d);			
		cal.add(Calendar.HOUR_OF_DAY, -xhour);
		Date date = cal.getTime() ;
	...
	public static String lastXHour_yyyyMMddHHmm(String yyyyMMddHHmm , int xhour) throws Exception {
		Date d = new SimpleDateFormat("yyyyMMddHHmm").parse(yyyyMMddHHmm);
		Calendar cal = Calendar.getInstance();  
		cal.setTime(d);			
		cal.add(Calendar.HOUR_OF_DAY, -xhour);
		Date date = cal.getTime() ;
	...
	public static String lastXHour_yyyyMMddHHmmss(String yyyyMMddHHmmss , int xhour) throws Exception {
		Date d = new SimpleDateFormat("yyyyMMddHHmmss").parse(yyyyMMddHHmmss);
		Calendar cal = Calendar.getInstance();  
		cal.setTime(d);			
		cal.add(Calendar.HOUR_OF_DAY, -xhour);
		Date date = cal.getTime() ;
   ...
   //////////////////////////////////////////////////////////////////
	...
	public static String lastXDay_yyyy_MM_dd(String yyyy_MM_dd , int xday) throws Exception {
		Date d = new SimpleDateFormat("yyyy_MM_dd").parse(yyyy_MM_dd);
		Calendar cal = Calendar.getInstance();  
		cal.setTime(d);			
