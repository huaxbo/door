...
public class ReportDataType206 {
	//协议支持的参量种类
	...
	protected Integer baoJing ;//置“1”为上报报警数据，清“0”为不上报报警数据；
	protected Integer neiCun ;//
	protected Integer guTai ;//
	protected Integer shuiYa ;//置“1”为上报水压数据，清“0”为不上报水压数据；
	...
	public String toString(){
		...
		s += "报警" + ":" + (this.baoJing==null?"":this.baoJing.intValue()) + "\n" ;
		s += "水压" + ":" + (this.shuiYa==null?"":this.shuiYa.intValue()) + "\n" ;
		s += "内存" + ":" + (this.neiCun==null?"":this.neiCun.intValue()) + "\n" ;
		s += "固态存储" + ":" + (this.guTai==null?"":this.guTai.intValue()) + "\n" ;
		return s ;
	}
	...
	public void setShuiYa(Integer shuiYa) {
		this.shuiYa = shuiYa;
	}
	...
	public void setNeiCun(Integer neiCun) {
		this.neiCun = neiCun;
	}
	...
	public void setGuTai(Integer guTai) {
		this.guTai = guTai;
	}
}
