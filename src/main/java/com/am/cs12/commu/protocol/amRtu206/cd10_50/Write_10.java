...
public class Write_10 {
	...
	public byte[] remoteData(String rtuId, HashMap<String , Object> params, Integer[] keyPassword) throws Exception {
		Param206_cd10 param = (Param206_cd10)params.get(Param206_cd10.KEY) ;
		if(param == null ){
		...
		b = new CodeProtocol().createCode(b, Code206.cd_10, fromSite) ;
		...
		b = rp.createRtuId(b, newId, Constant.RTU_ID_type_RTU_206 , fromSite);
